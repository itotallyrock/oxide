use crate::game::Shiftable;
use std::ops::{BitOr, BitXor, Not, BitAnd};
use std::fmt::{UpperHex, LowerHex, Debug};

pub trait BoardMask: Shiftable + UpperHex + LowerHex + BitOr + BitXor + BitAnd + Not + Eq + PartialEq + Debug + IntoIterator {
